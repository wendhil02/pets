    ...
    series: [
      {
        name: "Orders",
        data: [
          32, 66, 44, 55, 41, 24, 67, 22, 43, 32, 66, 44, 55, 41, 24, 67, 22,
          43,
        ],
      },

      {
        name: "Visitors",
        data: [
          7, 30, 13, 23, 20, 12, 8, 13, 27, 7, 30, 13, 23, 20, 12, 8, 13, 27,
        ],
      },
    ],
    chart: {
    ...
    series: [
      {
        name: "Page views",
        data: [
          31, 28, 30, 51, 42, 88, 86, 31, 40, 28, 31, 58, 30, 51, 42, 109, 100,
          116,
        ],
      },
      {
  ...
  areaChartWidgetOptions = {
    series: [
      ...
      },
      {
        name: "Others",
        data: [
          5, 25, 9, 14, 14, 32, 21, 5, 12, 25, 5, 55, 9, 14, 14, 32, 21, 30,
        ],
      },
    ],
    chart: {
    ...
    fill: { type: "solid" },
    legend: { show: !1 },
    grid: { show: !1, padding: { top: -15, right: 0, bottom: -10, left: -15 } },
  },
...
var columnChartWidget2,
  columnChartWidget2options = {
    ...
    grid: { show: !1, padding: { top: 0, right: 0, bottom: -15, left: -15 } },
  },
...
var heatmapChartWidget,
  heatmapChartWidgetOptions = {
    series: [
      { name: "Mon", data: [61, 98, 16, 9, 97, 20, 14, 18, 19, 33, 76, 78] },
      { name: "Tue", data: [77, 76, 10, 47, 13, 56, 71, 83, 32, 57, 87, 96] },
      { name: "Wed", data: [48, 23, 27, 90, 37, 32, 88, 96, 65, 46, 63, 17] },
      { name: "Thu", data: [70, 33, 71, 90, 34, 63, 93, 80, 39, 40, 41, 67] },
      { name: "Fri", data: [78, 98, 19, 74, 41, 59, 95, 99, 37, 17, 11, 60] },
      { name: "Sat", data: [46, 95, 52, 36, 34, 65, 2, 3, 13, 77, 72, 71] },
      { name: "Sun", data: [2, 93, 68, 3, 53, 56, 79, 64, 46, 14, 22, 94] },
    ],
    ...
    grid: { show: !1, padding: { top: -10, right: 10, bottom: 0, left: 0 } },
    stroke: { show: !0, colors: [colors.borderColor], width: 1, dashArray: 0 },
  },
...
customAngle &&
  (customAngleChart = new ApexCharts(customAngle, customAngleOptions)).render();
