...
<!-- Logo Section -->
    ...
    <li><a href="parehistro.php" class="block text-sm py-3 px-3 rounded hover:bg-blue-700">🐾 Pet Register</a></li>
    <li><a href="sarilingpet.php" class="block text-sm py-3 px-3 rounded hover:bg-blue-700">📋 My Pets</a></li>

    <!-- ADOPTION MANAGEMENT -->
    <li class="mt-5 text-xs font-bold text-gray-300 uppercase">Adoption & adopted</li>
    <li><a href="iwantadopt.php" class="block text-sm py-3 px-3 rounded hover:bg-blue-700">🏡 Adopt a Pet</a></li>
    <li><a href="available_pets.php" class="block text-sm py-3 px-3 rounded hover:bg-blue-700">📜 Adopted List</a></li>
